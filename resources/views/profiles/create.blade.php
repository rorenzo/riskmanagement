                    ...
                    <form method="POST" action="{{ route('profiles.store') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 mb-3">
                                ...
                                <input type="text" class="form-control @error('luogo_nascita_cap') is-invalid @enderror" id="luogo_nascita_cap" name="luogo_nascita_cap" value="{{ old('luogo_nascita_cap') }}" maxlength="5">
