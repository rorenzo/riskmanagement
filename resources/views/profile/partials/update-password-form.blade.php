{{-- resources/views/profile/partials/update-password-form.blade.php (Adattato per Bootstrap 5) --}}
<section>
    <header>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-4">
        ...
        <div class="mb-3">
            <label for="update_password_password_confirmation" class="form-label">{{ __('Conferma Nuova Password') }}</label>
