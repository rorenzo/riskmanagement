{{-- resources/views/safety_courses/create.blade.php --}}
<x-app-layout>
    <x-slot name="header">
        <h2 class="h4 fw-semibold text-dark">
            {{ __('Nuovo Corso di Sicurezza') }}
        </h2>
    </x-slot>
            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="card shadow-sm">
                        <div class="card-header">{{ __('Crea Nuovo Corso di Sicurezza') }}</div>
                        <div class="card-body">
                            <form method="POST" action="{{ route('safety_courses.store') }}">
                                @csrf
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('duration_years') is-invalid @enderror" id="duration_years" name="duration_years" value="{{ old('duration_years') }}" min="0">
                                ...
                                <div class="d-flex justify-content-end">
                                    ...
                                    <button type="submit" class="btn btn-primary">{{ __('Salva Corso') }}</button>
                                </div>
                            </form>
                        </div>
                    </div>
